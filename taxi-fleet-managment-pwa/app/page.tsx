    ...
    <div className="flex flex-col min-h-screen items-center justify-between font-sans p-6 bg-white">
      <main className="flex flex-col items-center w-full max-w-sm">
        ...
        <h1 className="text-3xl font-bold text-center">
          Okay Taxi Cieszyn<br/>Fleet Manager
        </h1>
        
        <form className="flex flex-col w-full max-w-xs mt-8 space-y-3" onSubmit={handleSubmit}>
          <label htmlFor="login" className="text-lg font-semibold text-tertiary">Login</label>
          <input
            name="login"
            type="text"
          ...
          />
          <label htmlFor="password" className="text-lg font-semibold text-tertiary">Hasło</label>
          <input
            type="password"
