...
public class ShiftReport : BaseEntity
{
    ...
    private ShiftReport(Guid userId, string odometerPhotoUrl, int kilometersDriven, float cardTransactionsSum, DateTime shiftDate, Guid? carId = null)
    {
        UserId = userId;
    ...
    /// <param name="shiftDay">The date of shift</param>
    /// <param name="carId">The optional unique identifier of the <see cref="Car"/> used during this shift.</param>
    ...
    /// <item><description>The <paramref name="carId"/> is provided but is equal to <see cref="Guid.Empty"/>.</description></item>
    ...
    public static ShiftReport Create(Guid userId, string odometerPhotoUrl, int kilometersDriven,
        float cardTransactionsSum, DateTime shiftDay, Guid? carId = null)
    {
        ...
        return new ShiftReport(userId, odometerPhotoUrl, kilometersDriven, cardTransactionsSum, shiftDay, carId);
    }
