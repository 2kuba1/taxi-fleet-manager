        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KilometerRate = table.Column<float>(type: "real", nullable: false),
                    ContractType = table.Column<string>(type: "text", nullable: false, defaultValue: "Mandate"),
                    RoleId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShiftReports_CarId",
                schema: "business",
                table: "ShiftReports",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_ShiftReports_UserId",
                schema: "business",
                table: "ShiftReports",
                column: "UserId");
